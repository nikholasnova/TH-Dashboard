            ...
            <div className="flex items-center gap-2">
              {onManageNodes && (
                <button
                  ...
                  className="w-11 h-11 rounded-full bg-[var(--active-bg)] flex items-center justify-center text-[var(--fg-dim)] hover:text-[var(--fg)] hover:bg-[var(--hover-bg)] transition-colors"
